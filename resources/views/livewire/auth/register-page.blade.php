                        ...
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    @error( 'name' )
										<div
											class=" inset-y-0 w-full end-0 flex items-center justify-between pointer-events-none pe-3">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    @error( 'email' )
										<div
											class="  inset-y-0 end-0 justify-between w-full flex items-center pointer-events-none pe-3">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    @error( 'password' )
										<div
											class="  inset-y-0 end-0 flex justify-between w-full items-center pointer-events-none pe-3">
											<span class="text-red-500">{{$message}}</span>
											<svg class="h-5 w-5 text-red-500" width="16" height="16" fill="currentColor"
												viewBox="0 0 16 16" aria-hidden="true">
												<path
