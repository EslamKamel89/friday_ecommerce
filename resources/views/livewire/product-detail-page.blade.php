    ...
    <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
        <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
            <div class="flex flex-wrap -mx-4">
                <!-- Image Section  ----------------------------------------------->
                <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{asset(ltrim(" storage/") . collect(
                    $product->images )->last() )}}' }">
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        <div class="relative mb-6 lg:mb-10 h-96 ">
                            <img x-bind:src="mainImage" alt="" class="object-cover w-full lg:h-full ">
                        </div>
                        <div class="flex-wrap hidden md:flex ">
                            @foreach ( $product->images as $image )
                            <div wire:key="{{'image ' . $image}}" class="w-1/2 p-2 sm:w-1/4"
                                x-on:click="mainImage='{{asset( ltrim(" storage"))."/" . $image }}'">
                    ...
                    <div class="lg:pl-20">
                        ...
                        <div class="mb-8 ">
                            ...
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                ...
                                <span
                                    class="text-base font-normal text-gray-500 line-through dark:text-gray-400">{{Number::currency(
                                    $product->price * 1.5, 'USD' )}}</span>
                            </p>
                        ...
                        <div class="w-32 mb-8 ">
                            ...
                            <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                                ...
                                <!-- Decrement button  -->
                                <!-- Count label  ----------------------------------------------->
                                <input type="number" wire:model.blur="quantity" placeholder="1"
