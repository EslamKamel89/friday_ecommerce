<div class="text-red-500">
            ...
            <div class="grid gap-4 md:grid-cols-2 md:items-center md:gap-8 xl:gap-20">
                <div>
                    <h1
                        ...
                        <span class="text-blue-600">Friday</span>
                    </h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">
                        Purchase wide varities of electronics products like
                        Smartphones, Laptops, Smartwatches, Television and many
                        more.
                    </p>
                ...
                <div class="relative ms-4">
                    ...
                    <div
                        class="absolute inset-0 -z-[1] -mb-4 -ms-4 me-4 mt-4 h-full w-full rounded-md bg-gradient-to-tr from-gray-200 via-white/0 to-white/0 lg:-mb-6 lg:-ms-6 lg:me-6 lg:mt-6 dark:from-slate-800 dark:via-slate-900/0 dark:to-slate-900/0">
                    </div>
    ...
    <div class="bg-orange-200 py-20">
        <!-- Categroy Title and description ------------------------------------------>
        <div class="mx-auto max-w-xl">
            <div class="text-center">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200">
                        Browse
                        <span class="text-blue-500">Categories</span>
                    </h1>
                    <div class="mb-6 mt-2 flex w-40 overflow-hidden rounded">
                        <div class="h-2 flex-1 bg-blue-200"></div>
                        <div class="h-2 flex-1 bg-blue-400"></div>
    ...
    <section class="font-poppins py-14 dark:bg-gray-800">
        <div class="mx-auto max-w-6xl px-4 py-6 md:px-6 lg:py-4">
            <div class="mx-auto max-w-xl">
                <div class="text-center">
                    <div class="relative flex flex-col items-center">
                        <h1 class="text-5xl font-bold dark:text-gray-200">
                            Customer
                            <span class="text-blue-500">Reviews</span>
                        </h1>
                        <div class="mb-6 mt-2 flex w-40 overflow-hidden rounded">
                            <div class="h-2 flex-1 bg-blue-200"></div>
                            <div class="h-2 flex-1 bg-blue-400"></div>
                    ...
                    <p class="mb-12 text-center text-base text-gray-500">
                        ...
                        elit. Delectus magni eius eaque? Pariatur numquam, odio
                        quod nobis ipsum ex cupiditate?
                    </p>
                </div>
            </div>

            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div class="rounded-md bg-white py-6 shadow dark:bg-gray-900">
                    <div
                        class="mb-6 flex flex-wrap items-center justify-between space-x-2 border-b pb-4 dark:border-gray-700">
                        <div class="mb-2 flex items-center px-6 md:mb-0">
                            <div class="mr-2 flex rounded-full">
                    ...
                    <p class="mb-6 px-6 text-base text-gray-500 dark:text-gray-400">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Autem cupiditate similique, iure minus sed fugit
                        obcaecati minima quam reiciendis dicta!
                    </p>
                    <div class="flex flex-wrap justify-between border-t pt-4 dark:border-gray-700">
                        <div class="mb-2 flex px-6 md:mb-0">
                            <ul class="mr-4 flex items-center justify-start">
                                <li>
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor"
                                            class="bi bi-star-fill mr-1 w-4 text-blue-500 dark:text-blue-400"
                                            viewBox="0 0 16 16">
                                            <path
                        ...
                        <div
                            class="flex items-center space-x-1 px-6 text-sm font-medium text-gray-500 dark:text-gray-400">
                            <div class="flex items-center">
                                <div class="mr-3 flex text-sm text-gray-700 dark:text-gray-400">
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor"
                                            class="bi bi-hand-thumbs-up-fill mr-1 h-4 w-4 text-blue-400"
                                            viewBox="0 0 16 16">
                                            <path
                                ...
                                <div class="flex text-sm text-gray-700 dark:text-gray-400">
                                    <a href="#" class="inline-flex hover:underline">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-chat mr-1 h-4 w-4 text-blue-400"
                                            viewBox="0 0 16 16">
                                            <path
